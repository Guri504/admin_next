(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_30d32c._.js", {
...
"[project]/src/app/(dashboard)/training_plan_services/add/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const Training_Plan_Service_Add = ()=>{
    ...
    const serviceSubmit = async (e)=>{
        ...
        try {
            let resp1 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["postApi"])('admin/trainingPlanService/add', finalData);
...
_s(Training_Plan_Service_Add, "WxK1o+TBrveEPBrtpN3GGjqjhCw=");
_c = Training_Plan_Service_Add;
const __TURBOPACK__default__export__ = Training_Plan_Service_Add;
var _c;
__turbopack_refresh__.register(_c, "Training_Plan_Service_Add");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/app/(dashboard)/training_plan_services/add/page.js [app-rsc] (ecmascript, Next.js server component, client modules)": ((__turbopack_context__) => {
...
//# sourceMappingURL=src_30d32c._.js.map