/* [project]/node_modules/ckeditor5-premium-features/dist/ckeditor5-premium-features.css [app-client] (css) */
:root {
...
.ck .ck-comment ul, .ck .ck-comment__input ul, .ck .ck-comment ol, .ck .ck-comment__input ol {
  padding-left: 10px;
  margin-left: 10px;
}
...
:where([uc-wgt-common]) uc-select[disabled], :where([uc-wgt-common]) select[disabled] {
  opacity: .6;
  pointer-events: none;
}
...
uc-editor-button-control, uc-editor-crop-button-control, uc-editor-filter-control, uc-editor-operation-control {
...
uc-editor-button-control > button, uc-editor-crop-button-control > button, uc-editor-filter-control > button, uc-editor-operation-control > button {
  all: unset;
  position: relative;
  display: grid;
...
:where(uc-editor-button-control, uc-editor-crop-button-control, uc-editor-filter-control, uc-editor-operation-control) > uc-icon > svg {
  width: var(--size-icon);
...
uc-editor-button-control.uc-active, uc-editor-operation-control.uc-active, uc-editor-crop-button-control.uc-active, uc-editor-filter-control.uc-active {
...
uc-editor-button-control.uc-not_active, uc-editor-operation-control.uc-not_active, uc-editor-crop-button-control.uc-not_active, uc-editor-filter-control.uc-not_active {
  --idle-color-rgb: var(--uc-secondary-foreground);
}

:where(.uc-contrast) uc-editor-button-control.uc-not_active, :where(.uc-contrast) uc-editor-operation-control.uc-not_active, :where(.uc-contrast) uc-editor-crop-button-control.uc-not_active, :where(.uc-contrast) uc-editor-filter-control.uc-not_active {
...
uc-editor-button-control > button:before, uc-editor-operation-control > button:before, uc-editor-crop-button-control > button:before, uc-editor-filter-control > button:before {
  position: absolute;
  content: "";
  right: 0;
  left: 0;
...
uc-editor-button-control > button .uc-title, uc-editor-operation-control > button .uc-title, uc-editor-crop-button-control > button .uc-title, uc-editor-filter-control > button .uc-title {
...
uc-editor-button-control > button uc-icon, uc-editor-operation-control > button uc-icon, uc-editor-crop-button-control > button uc-icon, uc-editor-filter-control > button uc-icon {
  pointer-events: none;
}
...
/*# sourceMappingURL=node_modules_ckeditor5-premium-features_dist_ckeditor5-premium-features_b52d8e.css.map*/