(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_d54269._.js", {
...
const EditBLog = ()=>{
    ...
    const fetchCategories = async ()=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to load categories");
        }
    };
    const defaultData = async ()=>{
        try {
            if (!params.id) return;
            let resp = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`http://localhost:4000/admin/blog/view/${params.id}`);
    ...
    const updatedBlogSubmit = async (e)=>{
        ...
        try {
            ...
            let resp = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`http://localhost:4000/admin/blog/edit/${params.id}`, finalUpdatedData);
            console.log("///", resp);
            if (resp.status !== 200) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])("CAtegory not upadted");
            }
        } catch (error) {
    ...
    const uploadClick = async (e)=>{
        ...
        if (file) {
            ...
            let resp = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("http://localhost:4000/uploads/base64", saveImage, {
                onUploadProgress: (e)=>{
...
_s(EditBLog, "rH23CueZvmsEA0HRv6LXv2Agm5I=", false, function() {
    return [
...
//# sourceMappingURL=src_app_d54269._.js.map