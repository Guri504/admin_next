 ...
 */ __turbopack_esm__({
    ...
    "DocumentListProperties": (()=>DocumentListProperties),
    ...
    "ListUI": (()=>ListUI),
    "ListUtils": (()=>ListUtils),
    "TodoDocumentList": (()=>TodoDocumentList),
    "TodoList": (()=>TodoList),
 ...
 */ class ListUI extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ckeditor$2f$ckeditor5$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Plugin"] {
	 ...
	 */ init() {
        ...
        if (!this.editor.ui.componentFactory.has('numberedList')) {
            createUIComponents(this.editor, 'numberedList', t('Numbered List'), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ckeditor$2f$ckeditor5$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["icons"].numberedList);
        }
        // Create button bulletedList.
        if (!this.editor.ui.componentFactory.has('bulletedList')) {
            createUIComponents(this.editor, 'bulletedList', t('Bulleted List'), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ckeditor$2f$ckeditor5$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["icons"].bulletedList);
        }
    }
}
/**
    ...
    init() {
        ...
        if (stylesListTypes.includes('bulleted')) {
            ...
            editor.ui.componentFactory.add(commandName, getDropdownViewCreator({
                ...
                buttonLabel,
                buttonIcon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ckeditor$2f$ckeditor5$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["icons"].bulletedList,
                styleGridAriaLabel,
                styleDefinitions
            }));
        ...
        if (stylesListTypes.includes('numbered') || propertiesConfig.startIndex || propertiesConfig.reversed) {
            ...
            editor.ui.componentFactory.add(commandName, getDropdownViewCreator({
                ...
                parentCommandName: commandName,
                buttonLabel,
                buttonIcon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ckeditor$2f$ckeditor5$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["icons"].numberedList,
                styleGridAriaLabel,
                styleDefinitions
            }));
 ...
 */ function getMenuBarStylesMenuCreator({ editor, normalizedConfig, parentCommandName, buttonLabel, styleGridAriaLabel, styleDefinitions }) {
    return (locale)=>{
        ...
        menuView.buttonView.set({
            label: buttonLabel,
            icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ckeditor$2f$ckeditor5$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["icons"][parentCommandName]
        });
 ...
 */ class TodoListUI extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ckeditor$2f$ckeditor5$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Plugin"] {
	 ...
	 */ init() {
        const t = this.editor.t;
        createUIComponents(this.editor, 'todoList', t('To-do List'), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ckeditor$2f$ckeditor5$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["icons"].todoList);
    }
}
/**
 ...
 */ function getSiblingNodes(position, direction) {
    ...
    const nodes = [
        ...new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ckeditor$2f$ckeditor5$2d$engine$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TreeWalker"](walkerOptions)
 ...
 */ function getListItemFillerOffset() {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ckeditor$2f$ckeditor5$2d$engine$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getFillerOffset"].call(this);
}
/**
 ...
 */ function findNextListItem(startPosition) {
    const treeWalker = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ckeditor$2f$ckeditor5$2d$engine$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TreeWalker"]({
        startPosition
    });
    let value;
    do {
 ...
 *
 * @deprecated
 */ class DocumentList extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ckeditor$2f$ckeditor5$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Plugin"] {
    /**
	 * @inheritDoc
	 */ static get requires() {
        return [
    ...
    constructor(editor){
		 ...
		 */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ckeditor$2f$ckeditor5$2d$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logWarning"])('plugin-obsolete-documentlist', {
 ...
 *
 * @deprecated
 */ class DocumentListProperties extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ckeditor$2f$ckeditor5$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Plugin"] {
    /**
	 * @inheritDoc
	 */ static get requires() {
        return [
    ...
    constructor(editor){
		 ...
		 */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ckeditor$2f$ckeditor5$2d$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logWarning"])('plugin-obsolete-documentlistproperties', {
 ...
 *
 * @deprecated
 */ class TodoDocumentList extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ckeditor$2f$ckeditor5$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Plugin"] {
    /**
	 * @inheritDoc
	 */ static get requires() {
        return [
    ...
    constructor(editor){
		 ...
		 */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ckeditor$2f$ckeditor5$2d$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logWarning"])('plugin-obsolete-tododocumentlist', {
...
//# sourceMappingURL=node_modules_%40ckeditor_ckeditor5-list_dist_index_93a067.js.map