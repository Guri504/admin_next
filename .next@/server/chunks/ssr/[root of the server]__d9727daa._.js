...
"[project]/src/app/(dashboard)/success_stories/view/[id]/page.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const Success_Stories_VewPage = ()=>{
    ...
    const getstory = async ()=>{
        try {
            let resp = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getApi"])(`admin/success_stories/view/${id}`);
            console.log(resp);
            if (resp.status) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d9727daa._.js.map