...
"[project]/src/app/(dashboard)/success_stories/edit/[id]/page.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const Success_Stories_Edit = ()=>{
    ...
    const defaultdata = async ()=>{
        try {
            let resp1 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getApi"])(`admin/success_stories/view/${id}`);
            console.log(resp1);
            if (resp1.status) {
    ...
    const storySubmit = async (e)=>{
        ...
        try {
            let resp1 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["putApi"])(`admin/success_stories/edit/${id}`, finalData);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1759a53a._.js.map