...
"[project]/src/app/(dashboard)/membership_plans/view/[id]/page.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const Membership_Plan_VewPage = ()=>{
    ...
    const plan = async ()=>{
        try {
            let resp = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getApi"])(`admin/membershipPlan/view/${id}`);
            console.log(resp);
            if (resp.status) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1b25ddb3._.js.map