...
"[project]/src/app/(dashboard)/blogsCategory/edit/[id]/page.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const EditBLogCategory = ()=>{
    ...
    let catData = async ()=>{
        let resp = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getApi"])(`admin/blogsCategory/view/${params.id}`);
    ...
    const categorySubmit = async (e)=>{
        ...
        try {
            ...
            let resp = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`http://localhost:4000/admin/blogsCategory/edit/${params.id}`, finalCategoryData);
            console.log("Category Updated", resp);
            if (!resp.status) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"])("Not able to update category");
                return;
            }
            if (resp.status === 200) {
                setNewData({
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"])("Category updated successfully");
            } else {
...
"[project]/src/app/(dashboard)/blogsCategory/edit/[id]/page.js [app-rsc] (ecmascript, Next.js server component, client modules ssr)": ((__turbopack_context__) => {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__37d6b3._.js.map