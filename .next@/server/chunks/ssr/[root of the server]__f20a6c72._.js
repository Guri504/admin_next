...
"[project]/src/app/(dashboard)/pages/fitness_membership_plans/page.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const Membership_Plan_Titles = ()=>{
    ...
    const contentUpdate = async (e)=>{
        ...
        try {
            let resp = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["putApi"])(`admin/update-page-content/fitness-membership-plans`, finalData);
            console.log("resp", resp);
            if (resp.status) {
                e.target.reset();
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__f20a6c72._.js.map