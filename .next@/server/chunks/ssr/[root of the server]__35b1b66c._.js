...
"[project]/src/app/(dashboard)/membership_plans/edit/[id]/page.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const Membership_Plan_Edit = ()=>{
    ...
    const [planData, setPlanData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({});
    const getPlan = async ()=>{
        try {
    ...
    const planUpdate = async (e)=>{
        ...
        try {
            let resp = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["putApi"])(`admin/membershipPlan/edit/${id}`, finalData);
            console.log("resp", resp);
            if (resp.status) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__35b1b66c._.js.map