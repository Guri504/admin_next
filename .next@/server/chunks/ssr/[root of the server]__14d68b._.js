...
const BlogCategoryListing = ()=>{
    ...
    const deleteCategory = async (id)=>{
        try {
            ...
            let resp = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`http://localhost:4000/admin/blogsCategory/delete/${id}`);
            if (resp.status === 200) {
    ...
    const updateCategoryStatus = async (id, newStatus)=>{
        try {
            let resp = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`http://localhost:4000/admin/blogsCategory/edit/${id}`, {
                status: newStatus
            });
            if (resp.status === 200) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__14d68b._.js.map