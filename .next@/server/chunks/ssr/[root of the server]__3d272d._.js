    ...
    let catData = async ()=>{
        try {
            ...
            if (resp.status === 200) {
                ...
                console.log("log", resp.data.data);
                let allCategoriesResp = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("http://localhost:4000/admin/blogsCategory");
                if (allCategoriesResp.status === 200) {
                    const allCategories = allCategoriesResp.data.message;
                    console.log("==", allCategoriesResp.data.message);
                    // Find the index of the current category
                    const index = allCategories.findIndex((item)=>item._id === params.id);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__3d272d._.js.map