...
"[project]/src/app/(dashboard)/training_plans/edit/[id]/page.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const Training_Plan_Edit = ()=>{
    ...
    const planUpdate = async (e)=>{
        ...
        try {
            let resp = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["putApi"])(`admin/trainingPlan/edit/${id}`, finalData);
            console.log("resp", resp);
            if (resp.status) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__aaeb46b3._.js.map