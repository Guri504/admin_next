...
"[project]/src/app/(dashboard)/strategy_plans/add/page.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const Strategy_Plan_Add = ()=>{
    ...
    const planSubmit = async (e)=>{
        ...
        try {
            let resp = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["postApi"])('admin/strategy_plan/add', finalData);
            console.log("resp", resp);
            if (resp.status) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"])('Plan Data Submitted Successfully');
                e.target.reset();
            }
        } catch (error) {
            console.log(error);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__dd96b836._.js.map