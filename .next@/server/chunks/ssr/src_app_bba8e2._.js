...
const BlogListing = ()=>{
    ...
    const blogListing = async ()=>{
        try {
            let resp = await axios.get('http:/localhost:4000/admin/blogs');
            console.log("--", resp);
            if (resp.status === 200) {
                setBlogList(resp.data.message);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"])("List of Blogs");
            }
        } catch (error) {
...
//# sourceMappingURL=src_app_bba8e2._.js.map