...
const About_Me_Listing = () => {
    ...
    return (
        <div className='right_side'>
            <NavBottom title="Manage Winners Listing">
                <Link href={'/winners/add'} className='back_btn'>NEW</Link>
                                ...
                                <Row>
                                    <Col xxl={8} xl={8} lg={8} md={5} sm={5} xs={12}>
                                        <div className='header_left'>
                                            <div className='heading'>Here Is Your Winners Listing!</div>
                                        </div>
                                    </Col>
                                                ...
                                                <tr key={i}>
                                                    ...
                                                    <td>
                                                        <Dropdown>
                                                            ...
                                                            <Dropdown.Menu>
                                                                <Dropdown.Item href={`/winners/edit/${winner?._id}`}><span className='edit'>
                                                                    <FontAwesomeIcon icon={faEdit} /></span> Edit
                                                                </Dropdown.Item>
                                                                <Dropdown.Item href={`/winners/view/${winner?._id}`}>
                                                                    <span className='view'><FontAwesomeIcon icon={faEye} />
                                                                    </span> View</Dropdown.Item>
                                                                <Dropdown.Item href="#" onClick={() => deleteWinner(winner?._id)}>
...
export default About_Me_Listing;