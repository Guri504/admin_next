...
const Training_Plan_Service_VewPage = () => {
    ...
    return (
        <div className='right_side'>
            <NavBottom title="Manage Service" backUrl="/training_plan_services" />
                    ...
                    <Col xxl={7} xl={7} lg={7} md={7} sm={7} xs={12}>
                        <Card>
                            ...
                            <div className='card-footer'>
                                ...
                                <div className='desc' dangerouslySetInnerHTML={{ __html: viewService?.description }} />
                            </div>
                        </Card>
                    </Col>
...
export default Training_Plan_Service_VewPage;