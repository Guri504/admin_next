...
const Products_Listing = () => {
    ...
    return (
        <div className='right_side'>
            <NavBottom title="Manage Products Listing">
                <Link href={'/products/add'} className='back_btn'>NEW</Link>
                                ...
                                <Row>
                                    <Col xxl={8} xl={8} lg={8} md={5} sm={5} xs={12}>
                                        <div className='header_left'>
                                            <div className='heading'>Here Is Your Products Listing!</div>
                                        </div>
                                    </Col>
                                    ...
                                    <Table>
                                        <thead>
                                            <tr>
                                                ...
                                                <th>PRODUCT NAME <span className='sort_icon'><FontAwesomeIcon icon={faSort} /></span></th>
                                        ...
                                        <tbody>
                                            {productList?.length > 0 && productList.map((product, i) => (
                                                <tr key={i}>
                                                    ...
                                                    <td><div className='tab'><Link href={`/products/view/${product?._id}`}>{product?.productName}</Link></div></td>
                                                    <td>{product?.productCategory.map(cat => (
                                                        category.find(item => item.value === cat)?.label || "Unknown"
                                                    ))}</td>
                                                    <td>
                                                        <Form.Group className='form-group'>
                                                            <Form.Check 
                                                    ...
                                                    <td>
                                                        <Dropdown>
                                                            ...
                                                            <Dropdown.Menu>
                                                                <Dropdown.Item href={`/products/edit/${product?._id}`}><span className='edit'>
                                                                    <FontAwesomeIcon icon={faEdit} /></span> Edit
                                                                </Dropdown.Item>
                                                                <Dropdown.Item href={`/products/view/${product?._id}`}>
                                                                    <span className='view'><FontAwesomeIcon icon={faEye} />
                                                                    </span> View</Dropdown.Item>
                                                                <Dropdown.Item href="#" onClick={() => deleteProduct(product?._id)}>
