    ...
    return (
        <div className='right_side'>
            <NavBottom title="Manage Products Category Listing">
                <Link href={'/products_sizes/add'} className='back_btn'>NEW</Link>
                                ...
                                <Row>
                                    <Col xxl={8} xl={8} lg={8} md={5} sm={5} xs={12}>
                                        <div className='header_left'>
                                            <div className='heading'>Here Is Your Product Sizes Listing!</div>
                                        </div>
                                    </Col>
                                                ...
                                                <tr key={i}>
                                                    ...
                                                    <td>
                                                        <Dropdown>
                                                            ...
                                                            <Dropdown.Menu>
                                                                <Dropdown.Item href={`/products_sizes/edit/${size?._id}`}><span className='edit'>
                                                                    <FontAwesomeIcon icon={faEdit} /></span> Edit
                                                                </Dropdown.Item>
                                                                <Dropdown.Item href={`/products_sizes/view/${size?._id}`}>
                                                                    <span className='view'><FontAwesomeIcon icon={faEye} />
                                                                    </span> View</Dropdown.Item>
                                                                <Dropdown.Item href="#" onClick={() => deleteSize(size?._id)}>
...
export default Product_Sizes_Listing;