...
const Success_Stories_Listing = () => {
    ...
    return (
        <div className='right_side'>
            <NavBottom title="Manage Success Stories Listing">
                <Link href={'/success_stories/add'} className='back_btn'>NEW</Link>
                                ...
                                <Row>
                                    <Col xxl={8} xl={8} lg={8} md={5} sm={5} xs={12}>
                                        <div className='header_left'>
                                            <div className='heading'>Here Is Your Success Stories Listing!</div>
                                        </div>
                                    </Col>
                                                ...
                                                <tr key={i}>
                                                    ...
                                                    <td>
                                                        <Dropdown>
                                                            ...
                                                            <Dropdown.Menu>
                                                                <Dropdown.Item href={`/success_stories/edit/${stories?._id}`}><span className='edit'>
                                                                    <FontAwesomeIcon icon={faEdit} /></span> Edit
                                                                </Dropdown.Item>
                                                                <Dropdown.Item href={`/success_stories/view/${stories?._id}`}>
                                                                    <span className='view'><FontAwesomeIcon icon={faEye} />
                                                                    </span> View</Dropdown.Item>
                                                                <Dropdown.Item href="#" onClick={() => deleteStories(stories?._id)}>
...
export default Success_Stories_Listing;