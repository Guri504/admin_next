...
const Training_Plans_Listing = () => {
    ...
    return (
        <div className='right_side'>
            <NavBottom title="Manage Training Plan Listing">
                <Link href={'/training_plans/add'} className='back_btn'>NEW</Link>
                                ...
                                <Row>
                                    <Col xxl={8} xl={8} lg={8} md={5} sm={5} xs={12}>
                                        <div className='header_left'>
                                            <div className='heading'>Here Is Your Training Plan Listing!</div>
                                        </div>
                                    </Col>
                                                ...
                                                <tr key={i}>
                                                    ...
                                                    <td>
                                                        <Dropdown>
                                                            ...
                                                            <Dropdown.Menu>
                                                                <Dropdown.Item href={`/training_plans/edit/${plan._id}`}><span className='edit'>
                                                                    <FontAwesomeIcon icon={faEdit} /></span> Edit
                                                                </Dropdown.Item>
                                                                <Dropdown.Item href={`/training_plans/view/${plan._id}`}>
...
export default Training_Plans_Listing;